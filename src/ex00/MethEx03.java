 ...
 * 3.출구가 없을때 void사용, 출구가 있을때는 타입을 동일하게 해준다.
 * 4.메서드 내부(queue)를 몰라도 사용할 수 있다.(캡슐화)
 * 5.메서드는 1 급 객체인가?->아니다. 자바에서는 1급 객체가 class 밖에 없다.
 * 6.메서드는 왜 만들어? 특정한 역할(목적0을 수행하는 코드 꾸러미를 만들어 둘려고)
 * -캡슐화, 재사용, 코드 관리도 편함, 메모리 관리에도 엄청나게 효과적임
